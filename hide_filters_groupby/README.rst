...
Hide Filters Groupby helps you to hide filter and group by option.

Key Features
------------

* Option to hide filter and group by option globally.
* Option to hide filter and group by option on specific models.
