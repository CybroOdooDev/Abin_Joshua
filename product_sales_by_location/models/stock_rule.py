...
class StockRule(models.Model):
    """By inheriting this model generating corresponding product's stock  moves."""
    _inherit = 'stock.rule'
    ...
    def _get_stock_move_values(self, product_id, product_qty, product_uom,
        ...
        return super()._get_stock_move_values(product_id,product_qty,product_uom,location_id,name, origin,company_id,values)
