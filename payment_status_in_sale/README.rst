...
Displays real-time invoice and payment status badges and details directly on sale orders.

Key Features
------------

* Displays payment status badge (e.g., Not Paid, Partially Paid, Paid) on Sale Orders.
* Quick visibility of payment status without navigating to invoices.
* Track invoiced amount, amount paid, and residual amount on the order form.
* Filter and group sale orders by payment status in list view.
